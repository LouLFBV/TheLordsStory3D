...
public class BasicBehaviour : MonoBehaviour
{
    ...
    [SerializeField] private ThirdPersonOrbitCamBasic camScript;           // Référence au script de caméra à la 3ᵉ personne.
    ...
    public bool movementLocked = false;                  // Indique si le mouvement du joueur est temporairement bloqué.
